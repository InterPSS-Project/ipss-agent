...
Reads CSV output from InterPSS ACLF/CA (``python ../src/main/py/ipss_cmd.py`` from ``wspace/``) and produces a TPL-001-5
...
Usage (from ``wspace/`` with venv activated):
  python ../src/main/py/report/generate_nerc_tpl_report.py <case_display_name> <result_dir>
  python ../src/main/py/report/generate_nerc_tpl_report.py 'IEEE 118-Bus Test Case' data/ieee/Ieee118Bus/result
  python ../src/main/py/report/generate_nerc_tpl_report.py 'Texas 2000-Bus System' data/psse/Texas2K/result
...
def _default_case_name():
    ...
    raise ValueError(
        ...
        "Run `python ../src/main/py/ipss_cmd.py` first to generate CSV outputs."
    )
...
def generate_report(case_name, result_dir=None):
    ...
    if contingency_results:
        ...
        w(">")
        w("> ```bash")
        w("> python ../src/main/py/ipss_cmd.py ca <format> <input>")
        w("> ```")
        w("")
    ...
    if contingency_results:
        ...
        w(_md_table_row("Contingency Data", "MISSING", "Run `python ../src/main/py/ipss_cmd.py ca` to generate contingency analysis."))
    w("")
    ...
    w(_md_table_row("Field", "Value"))
    w(_md_table_sep(2))
    w(_md_table_row("Generated By", "`src/main/py/report/generate_nerc_tpl_report.py`"))
...
if __name__ == "__main__":
    if len(sys.argv) >= 3:
        ...
        print("Usage: python ../src/main/py/report/generate_nerc_tpl_report.py <case_name> <result_dir>")
        print("Example: python ../src/main/py/report/generate_nerc_tpl_report.py 'IEEE 118-Bus' data/ieee/Ieee118Bus/result")
        print("Example: python ../src/main/py/report/generate_nerc_tpl_report.py 'Texas 2K' data/psse/Texas2K/result")
        print("\nBackward-compatible mode also supported:")
        print("  python ../src/main/py/report/generate_nerc_tpl_report.py <discovered_alias_or_case_dir>")
        sys.exit(1)
