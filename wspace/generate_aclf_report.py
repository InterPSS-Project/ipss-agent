...
Usage:
  python generate_aclf_report.py <case_display_name> <result_dir> [csv_prefix]
...
def generate_aclf_report(
    ...
    w(_md_table_row("Field", "Value"))
    w(_md_table_sep(2))
    w(_md_table_row("Generated By", "`generate_aclf_report.py`"))
...
if __name__ == "__main__":
    if len(sys.argv) < 3:
        print("Usage: python generate_aclf_report.py <case_display_name> <result_dir> [csv_prefix]")
        print(
            "Example: python generate_aclf_report.py 'IEEE 118-Bus Test Case' data/ieee/result"
        )
        print(
            "Example: python generate_aclf_report.py 'IEEE 14-Bus System' data/ieee/result ieee14"
        )
        print(
            "Example: python generate_aclf_report.py 'Texas 2000-Bus System' data/psse/Texas2K/result"
        )
        sys.exit(1)
