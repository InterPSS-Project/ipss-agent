...
if args.simutype == "aclf":
    ...
    # Basic network summary (same fields as desktop NetworkUtil.getBasicNetworkInfo)
    with open(results_dir / (out_file_prefix + "_network_info.txt"), "w") as f:
        f.write(network_info(net))
